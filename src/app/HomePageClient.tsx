    ...
    <>
      ...
      <Section background="white" padding="lg" id="services">
        <Container>
          ...
          <p className="text-body-lg max-w-2xl text-slate mx-auto text-center mt-4">
            Proudly serving small businesses across Volusia County — including New Smyrna Beach, Edgewater, Daytona Beach, Port Orange, and Ormond Beach, FL.
          </p>
